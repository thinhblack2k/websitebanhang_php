...
<!-- Mirrored from risingtheme.com/html/suruchi-demo/suruchi/404.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Apr 2022 09:00:46 GMT -->
<head>
  <meta charset="utf-8">
                    ...
                    <div class="language__currency d-none d-lg-block">
                        <ul class="d-flex align-items-center">
                            <li class="language__currency--list">
                                <a class="language__switcher text-white" href="login.php">
                                    <span>Đăng Nhập</span>
                                </a>
                            </li>
                            <li class="language__currency--list">
            ...
            <div class="container-fluid">
                <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                    ...
                    <div class="main__logo">
                        <h1 class="main__logo--title"><a class="main__logo--link" href="index.php"><img class="main__logo--img" src="https://tokyolife.com.vn/static/media/LOGO TKL_Web.389bc974.svg" alt="logo-img"></a></h1>
                    </div>
                    ...
                    <div class="header__menu d-none header__sticky--block d-lg-block">
                        <nav class="header__menu--navigation">
                            <ul class="d-flex">
                                ...
                                <li class="header__menu--items style2">
                                    <a class="header__menu--link text-white" href="shop.php">Cửa Hàng
                                        <svg class="menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12" height="7.41" viewBox="0 0 12 7.41">
                                            <path  d="M16.59,8.59,12,13.17,7.41,8.59,6,10l6,6,6-6Z" transform="translate(-6 -8.59)" fill="currentColor" opacity="0.7"/>
                                        </svg>
                                    </a>
                                    <ul class="header__sub--menu">
                                        <li class="header__sub--menu__items"><a href="shop.php" class="header__sub--menu__link">Nam</a></li>
                                        <li class="header__sub--menu__items"><a href="shop.php" class="header__sub--menu__link">Nữ</a></li>
                                        <li class="header__sub--menu__items"><a href="shop.php" class="header__sub--menu__link">Trẻ em</a></li>
                                        <li class="header__sub--menu__items"><a href="shop.php" class="header__sub--menu__link">Phụ Kiện</a></li>
                                    </ul>
                                </li>
                                <li class="header__menu--items style2">
                                    <a class="header__menu--link text-white" href="about.php">Giới Thiệu</a>  
                                </li>
                                <li class="header__menu--items style2">
                                    <a class="header__menu--link text-white" href="blog.php">Tin Tức</a>
                                </li>
                                <li class="header__menu--items style2 d-none d-xl-block">
                                    <a class="header__menu--link text-white" href="shop.php">Danh Mục </a>  
                                </li>
                                
                                <li class="header__menu--items style2">
                                    <a class="header__menu--link text-white" href="contact.php">Liên Hệ </a>  
                                </li>
                            </ul>
                        </nav>
                    </div>
            ...
            <div class="offcanvas__inner">
                <div class="offcanvas__logo">
                    <a class="offcanvas__logo_link" href="index.php">
                        <img src="https://tokyolife.com.vn/static/media/LOGO TKL_Web.389bc974.svg" alt="Grocee Logo" width="158" height="36">
                    </a>
                ...
                <nav class="offcanvas__menu">
                    <ul class="offcanvas__menu_ul">
                        ...
                        <li class="offcanvas__menu_li">
                            <a class="offcanvas__menu_item" href="shop.php">Cửa Hàng</a>
                            <ul class="offcanvas__sub_menu">
                                <li class="offcanvas__sub_menu_li"><a href="shop.php" class="offcanvas__sub_menu_item">Nam</a></li>
                                <li class="offcanvas__sub_menu_li"><a href="shop.php" class="offcanvas__sub_menu_item">Nữ</a></li>
                                <li class="offcanvas__sub_menu_li"><a href="shop.php" class="offcanvas__sub_menu_item">Trẻ em</a></li>
                                <li class="offcanvas__sub_menu_li"><a href="shop.php" class="offcanvas__sub_menu_item">Phụ Kiện</a></li>
                            </ul>
                        </li>
                        <li class="offcanvas__menu_li">
                            <a class="offcanvas__menu_item" href="blog.php">Tin Tức</a>
                        </li>
                        <li class="offcanvas__menu_li"><a class="offcanvas__menu_item" href="about.php">Giới Thiệu</a></li>
                        <li class="offcanvas__menu_li"><a class="offcanvas__menu_item" href="contact.php">Liên Hệ</a></li>
                    </ul>
     ...
     <footer class="footer__section bg__black">
        <div class="container-fluid">
            ...
            <div class="footer__bottom d-flex justify-content-between align-items-center">
                <p class="copyright__content text-ofwhite m-0">Copyright © 2022 <a class="copyright__content--link" href="index.php">Suruchi</a> . All Rights Reserved.Design By Suruchi</p>
