...
if (isset($_SESSION['dangky'])) {
    $sql_lietke_dondat_lietke = "SELECT * FROM tbldondat WHERE  GmailKH = '" .$gmail. "' AND TinhTrang = '3'";
        ...
        <div class="my__account--section__inner border-radius-10 d-flex">
            <div class="account__left--sidebar">
                ...
                <ul class="account__menu">
                    ...
                    <li class="account__menu--list active"><a href="index.php?page=myhistory">Lịch sử</a></li>
