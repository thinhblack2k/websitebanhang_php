...
$sql_lietke_sanpham_timkiem = "SELECT * FROM tblsanpham,tblloaisp WHERE tblsanpham.IdLoaiSP = tblloaisp.IdLoaiSP 
AND tblsanpham.TenSP LIKE '%" . $tukhoa . "%' ORDER BY tblsanpham.IdLoaiSP DESC LIMIT $begin,8";
$query_lietke_sanpham_timkiem = mysqli_query($mysqli, $sql_lietke_sanpham_timkiem);
?>
        ...
        <div class="shop__header bg__gray--color d-flex align-items-center justify-content-between mb-30">
            ...
            <div class="product__view--mode d-flex align-items-center">
                ...
                <div class="product__view--mode__list product__view--search d-none d-lg-block">
                    <span style="font-weight: 600;">Tìm kiếm theo :</span> <i><?php echo $tukhoa ?></i>
                </div>
            </div>
                ...
                <div class="shop__product--wrapper">
                        ...
                        <div id="product_grid" class="tab_pane active show">
                            <div class="product__section--inner product__grid--inner">
                                <div class="row row-cols-xl-4 row-cols-lg-3 row-cols-md-3 row-cols-2 mb--n30">
                                    <?php
                                    $i = 0;
                                    while ($sanphamtimkiem =  mysqli_fetch_array($query_lietke_sanpham_timkiem)) {
                                        $i++;
                                    ?>
                                        <div class="col mb-30">
                                            <div class="product__items">
                                                <div class="product__items--thumbnail">
                                                    <a class="product__items--link" href="index.php?page=detail&id=<?php echo $sanphamtimkiem['IdSP'] ?>">
                                                        <img class="product__items--img product__primary--img" src="admin/modules/quanlysanpham/uploads/<?php echo $sanphamtimkiem['HinhAnh'] ?>" alt="product-img">
                                                        <img class="product__items--img product__secondary--img" src="admin/modules/quanlysanpham/uploads/<?php echo $sanphamtimkiem['HinhAnh'] ?>" alt="product-img">
                                                    </a>
                                                    <div class="product__badge">
                                                        <span class="product__badge--items sale">Sale <?php echo $sanphamtimkiem['KhuyenMai'] ?>%</span>
                                                    </div>
                                                </div>
                                                <div class="product__items--content">
                                                    <h3 class="product__items--content__title h4"><a href="index.php?page=detail&id=<?php echo $sanphamtimkiem['IdSP'] ?>"><?php echo $sanphamtimkiem['TenSP'] ?></a></h3>
                                                    <div class="product__items--price">
                                                        <span class="old__price">₫<?php echo number_format($sanphamtimkiem['GiaBan'], 0, ',', '.') ?></span>
                                                        <br>
                                                        <span class="current__price" style="font-size: 25px; color: var(--secondary-color)">₫ <?php echo number_format($sanphamtimkiem['GiaBan'] - ($sanphamtimkiem['GiaBan'] / 100 * $sanphamtimkiem['KhuyenMai']), 0, ',', '.') ?></span>
                                                    </div>
                                                    <ul class="rating product__rating d-flex">
                                                        ...
                                                        <span class="product__items--content__subtitle">Đã bán <?php echo $sanphamtimkiem['SLBan'] ?></span>
                                                    </ul>
                        ...
                        <div id="product_list" class="tab_pane">
                            <div class="product__section--inner">
                                <div class="row row-cols-1 mb--n30">
                                    <?php
                                    $j = 0;
                                    while ($sanphamtimkiem2 =  mysqli_fetch_array($query_lietke_sanpham_timkiem)) {
                                        $j++;
                                    ?>
                                        <div class="col mb-30">
                                            <div class="product__items product__list--items d-flex">
                                                ...
                                                <div class="product__list--items__content">
                                                    <span class="product__items--content__subtitle mb-5"><?php echo $sanphamtimkiem2['TenLoai'] ?></span>
                                                    <h3 class="product__list--items__content--title h4 mb-10"><a href="product-details.php"><?php echo $sanphamtimkiem2['TenSP'] ?></a></h3>
                    ...
                    <div class="pagination__area bg__gray--color">
                        <nav class="pagination">
                            <?php
                            $sql_trang = mysqli_query($mysqli, "$sql_lietke_sanpham_timkiem");
                            ...
                            <ul class="pagination__wrapper d-flex align-items-center justify-content-center">
                                ...
                                <li>
                                    ...
                                    for ($i = 1; $i <= $trang; $i++) {
                                        if ($page == $i) {
                                    ?>
                                <li class="pagination__list"><a href="index.php?page=timkiem&trang=<?php echo $i ?>" class="pagination__item pagination__item--current"><?php echo $i ?></a></li>
                            <?php
                                        } else {
                            ?>
                                <li class="pagination__list"><a href="index.php?page=timkiem&trang=<?php echo $i ?>" class="pagination__item link"><?php echo $i ?></a></li>
                            <?php
                                        }
                            ?>
