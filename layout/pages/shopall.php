...
$sql_lietke_sanpham_tatca = "SELECT * FROM tblsanpham,tblloaisp WHERE tblsanpham.IdLoaiSP = tblloaisp.IdLoaiSP ORDER BY tblsanpham.IdLoaiSP DESC LIMIT $begin,8";
                        ...
                        <div id="product_grid" class="tab_pane active show">
                            <div class="product__section--inner product__grid--inner">
                                <div class="row row-cols-xl-4 row-cols-lg-3 row-cols-md-3 row-cols-2 mb--n30">
                                    <?php
                                    $i = 0;
                                    while ($sanphamtheoloai =  mysqli_fetch_array($query_lietke_sanpham_tatca)) {
                                        $i++;
                                    ?>
                                        <div class="col mb-30">
                        ...
                        <div id="product_list" class="tab_pane">
                            <div class="product__section--inner">
                                <div class="row row-cols-1 mb--n30">
                                    <?php
                                    $j = 0;
                                    while ($sanphamtheoloai2 =  mysqli_fetch_array($query_lietke_sanpham_tatca)) {
                                        $j++;
                                    ?>
                                        <div class="col mb-30">
                                            <div class="product__items product__list--items d-flex">
                                                ...
                                                <div class="product__list--items__content">
                                                    ...
                                                    <ul class="product__items--action d-flex">
                                                        <form action="layout/main/themgiohang.php?IdSP=<?php echo $sanphamtheoloai2['IdSP'] ?>" method="POST">
                                                            <li class="product__items--action__list">
                                                                <button class="product__items--action__btn add__to--cart" type="submit" name="addCart">
                                                                    <svg class="product__items--action__btn--svg" xmlns="http://www.w3.org/2000/svg" width="22.51" height="20.443" viewBox="0 0 14.706 13.534">
                                                                        <g transform="translate(0 0)">
