<?php
$sql_lietke_sanpham_banchay = "SELECT * FROM tblsanpham,tblthuonghieu,tblloaisp WHERE tblsanpham.IdTH = tblthuonghieu.IdTH and tblsanpham.IdLoaiSP = tblloaisp.IdLoaiSP ORDER BY IdSP DESC";
$query_lietke_sanpham_banchay = mysqli_query($mysqli, $sql_lietke_sanpham_banchay);
?>
    ...
    <div class="container-fluid">
        ...
        <div class="product__section--inner product__swiper--activation swiper">
            <div class="swiper-wrapper">
                <?php
                $i = 0;
                while ($row = mysqli_fetch_array($query_lietke_sanpham_banchay)) {
                    $i++;
                ?>
